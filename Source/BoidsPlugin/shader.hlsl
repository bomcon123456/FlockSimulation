...
MaterialFloat2 GetDefaultSceneTextureUV(FMaterialPixelParameters Parameters, const uint SceneTextureId)
{
    ...
    float3 GetObjectOrientation()
    {
        return Primitive.ObjectOrientation.xyz;
    }
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
    ...
    MaterialFloat2 Local1 = View.ViewSizeAndInvSize.zw;
    MaterialFloat Local2 = (Local1.r * Material.ScalarExpressions[0].y);
    MaterialFloat Local3 = (Local2 * 1.00000000);
    MaterialFloat2 Local4 = GetViewportUV(Parameters);
    MaterialFloat2 Local5 = (MaterialFloat2(Local3,0.00000000) + Local4);
    MaterialFloat2 Local6 = ClampSceneTextureUV(ViewportUVToSceneTextureUV(Local5, 24), 24);
    MaterialFloat4 Local7 = SceneTextureLookup(Local6, 24, false);
    MaterialFloat Local8 = (Local7.rgba.r / 255.00000000);
    MaterialFloat Local9 = ((abs(Local8 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local8 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat4 Local10 = SceneTextureLookup(GetDefaultSceneTextureUV(Parameters, 24), 24, false);
    MaterialFloat Local11 = (Local10.rgba.r / 255.00000000);
    MaterialFloat Local12 = ((abs(Local11 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local11 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat Local13 = (Local9 - Local12);
    MaterialFloat2 Local14 = (MaterialFloat2(0.00000000,Local3) + Local4);
    MaterialFloat2 Local15 = ClampSceneTextureUV(ViewportUVToSceneTextureUV(Local14, 24), 24);
    MaterialFloat4 Local16 = SceneTextureLookup(Local15, 24, false);
    MaterialFloat Local17 = (Local16.rgba.r / 255.00000000);
    MaterialFloat Local18 = ((abs(Local17 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local17 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat4 Local19 = SceneTextureLookup(GetDefaultSceneTextureUV(Parameters, 24), 24, false);
    MaterialFloat Local20 = (Local19.rgba.r / 255.00000000);
    MaterialFloat Local21 = ((abs(Local20 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local20 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat Local22 = (Local18 - Local21);
    MaterialFloat Local23 = (Local13 + Local22);
    MaterialFloat Local24 = (Local2 * -1.00000000);
    MaterialFloat2 Local25 = (MaterialFloat2(Local24,0.00000000) + Local4);
    MaterialFloat2 Local26 = ClampSceneTextureUV(ViewportUVToSceneTextureUV(Local25, 24), 24);
    MaterialFloat4 Local27 = SceneTextureLookup(Local26, 24, false);
    MaterialFloat Local28 = (Local27.rgba.r / 255.00000000);
    MaterialFloat Local29 = ((abs(Local28 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local28 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat4 Local30 = SceneTextureLookup(GetDefaultSceneTextureUV(Parameters, 24), 24, false);
    MaterialFloat Local31 = (Local30.rgba.r / 255.00000000);
    MaterialFloat Local32 = ((abs(Local31 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local31 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat Local33 = (Local29 - Local32);
    MaterialFloat Local34 = (Local23 + Local33);
    MaterialFloat2 Local35 = (MaterialFloat2(0.00000000,Local24) + Local4);
    MaterialFloat2 Local36 = ClampSceneTextureUV(ViewportUVToSceneTextureUV(Local35, 24), 24);
    MaterialFloat4 Local37 = SceneTextureLookup(Local36, 24, false);
    MaterialFloat Local38 = (Local37.rgba.r / 255.00000000);
    MaterialFloat Local39 = ((abs(Local38 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local38 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat4 Local40 = SceneTextureLookup(GetDefaultSceneTextureUV(Parameters, 24), 24, false);
    MaterialFloat Local41 = (Local40.rgba.r / 255.00000000);
    MaterialFloat Local42 = ((abs(Local41 - (3.00000000 / 255.00000000)) > 0.00001000) ? (Local41 >= (3.00000000 / 255.00000000) ? 0.00000000 : 0.00000000) : 1.00000000);
    MaterialFloat Local43 = (Local39 - Local42);
    MaterialFloat Local44 = (Local34 + Local43);
    MaterialFloat Local45 = min(max(Local44.r,0.00000000),1.00000000);
    MaterialFloat3 Local46 = lerp(Local0.rgba.rgb,Material.VectorExpressions[3].rgb,MaterialFloat(Local45));
    MaterialFloat3 Local47 = (Local46 + Material.VectorExpressions[4].rgb);
    ...
    float3 TranslatedWorldPositionExcludingShaderOffsets)
{
    ...
    Parameters.TwoSidedSign *= ResolvedView.CullingSign * Primitive.LocalToWorldDeterminantSign;
